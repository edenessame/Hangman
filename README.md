...
* When passing through the Python linter I was getting the error message: 80: W605 invalid escape sequence '\ ' on [Stackoverflow](https://stackoverflow.com/questions/52335970/how-to-fix-syntaxwarning-invalid-escape-sequence-in-python) I found that I had to write it as two \ to get a literal \ and not an escape character.
